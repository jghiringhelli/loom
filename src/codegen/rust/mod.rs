...
impl RustEmitter {
    ...
    pub fn emit(&self, module: &Module) -> String {
        ...
        // V7: emit a file-level audit trail header.
        out.push_str("// LOOM[v7:audit]: Generated by loom — do not edit manually.\n");
        out.push_str("// LOOM[v7:audit]: Each LOOM[...] comment records a correctness decision.\n\n");
