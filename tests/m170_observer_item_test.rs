...
"#,
    ...
    assert!(
        out.contains("TemperatureObserverObserver"),
        "expected struct\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("pub fn new(initial: T) -> Self"),
        "missing new(initial)\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("pub fn get(&self) -> &T"),
        "missing get()\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("pub fn notify(&mut self, new_value: T)"),
        "missing notify()\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("pub fn subscribe<F: Fn(&T)>"),
        "missing subscribe()\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("Observer<T = String>"),
...
"#,
    ...
    assert!(
        out.contains("LOOM[observer:behavioral]"),
...
"#,
    ...
    assert!(
        out.contains("StatusObserverObserver"),
        "missing status\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("DefaultStatusFallback"),
        "missing fallback\n{out}"
    );
}
