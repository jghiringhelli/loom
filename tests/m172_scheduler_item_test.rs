...
"#,
    ...
    assert!(
        out.contains("HeartbeatSchedulerScheduler"),
        "expected struct\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("pub fn run<F: Fn()>(&self, _task: F)"),
        "missing run()\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("pub fn stop(&mut self)"),
        "missing stop()\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("LOOM[scheduler:behavioral]"),
...
"#,
    ...
    assert!(
        out.contains("CleanupSchedulerScheduler"),
        "missing cleanup\n{out}"
    );
}
...
"#,
    ...
    assert!(
        out.contains("MetricsSchedulerScheduler"),
        "missing scheduler\n{out}"
    );
    assert!(
        out.contains("MetricsObserverObserver"),
        "missing observer\n{out}"
    );
}
